				...
				height="5" width="100%" /></div>
							...
							<table width="96%" border="1" align="center">
                                ...
                                <jstlcore:forEach items="${regEvents}" var="regEvent">
									<tr align="center">
										<td><jstlcore:out value="${fn:substring(visitor.lastName,0,4)}${fn:substring(visitor.firstName,0,3)}--${regEvent[7]}"></jstlcore:out></td>
										...
										<a href="<jstlcore:url value="/eventunreg.htm?eventId=${regEvent[0]}&eventsessionid=${regEvent[6]}"/>">Release</a>
										</td>
									</tr>									
								</jstlcore:forEach>
								<tr>
