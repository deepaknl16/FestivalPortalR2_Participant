...
public class EventDAO {
	...
	public ArrayList<Object[]> showAllEvents(String eventname)
		...
		while(resultSet.next()){
			...
			Object[] evtObject= new Object[8];
			evtObject[0] = resultSet.getInt("eventid"); 
			evtObject[1] = resultSet.getString("name");
			evtObject[2] = resultSet.getString("description");
			evtObject[3] = resultSet.getString("places");
			evtObject[4] = resultSet.getString("duration");
			evtObject[5] = resultSet.getString("eventtype");
			evtObject[6] = resultSet.getString("eventsessionid");
			evtObject[7] = resultSet.getInt("seatsavailable");
			
			eventList.add(evtObject);
		}
